                ...
                <div class="panel panel-default col-md-9 col-md-offset-2 col-lg-9 col-xs-12 ">
                    ...
                    <div class="panel-body table-responsive">
                        <table class="table-striped col-lg-8 col-md-8 col-xs-12">
                            ...
                            <tr>
                                <td>
                                    <label class="radio-inline"><input type="radio" name="p1" value="Redes Sociales">Redes Sociales</label>
                                    <label class="radio-inline"><input type="radio" name="p1" value="Internet">Internet</label>
                                    <label class="radio-inline"><input type="radio" name="p1" value="Radio">Radio</label>
                                    <label class="radio-inline"><input type="radio" name="p1" value="Televisión">Televisión</label>
                                    <label class="radio-inline"><input type="radio" name="p1" value="Por amigos">Por amigos</label>
                            ...
                            <tr><td><label class="radio-inline"><input type="radio" name="p2" value="Para fortalecer mi aprendizaje en la escuela">Para fortalecer mi aprendizaje en la escuela</label></td></tr>
                            <tr><td><label class="radio-inline"><input type="radio" name="p2" value="Para reforzar mis habilidades laborales">Para reforzar mis habilidades laborales</label></td></tr>                        
                            <tr><td><label class="radio-inline"><input type="radio" name="p2" value="Para mejorar mi currículo profesional">Para mejorar mi currículo profesional</label></td></tr>
                            <tr><td><label class="radio-inline"><input type="radio" name="p2" value="Por cultura general">Por cultura general</label></td></tr>
                            ...
                            <tr>
                                <td>
                                    <label class="radio-inline"><input type="radio" name="p3" value="Muy buena">Muy buena</label>
                                    <label class="radio-inline"><input type="radio" name="p3" value="Buena">Buena</label>                        
                                    <label class="radio-inline"><input type="radio" name="p3" value="Poco buena">Poco buena</label>
                                    <label class="radio-inline"><input type="radio" name="p3" value="Mala">Mala</label>
                            ...
                            <tr>
                                <td>
                                    ...
                                    <label class="radio-inline"><input type="radio" name="p4" value="Satisfecho">Satisfecho</label>                        
                                    <label class="radio-inline"><input type="radio" name="p4" value="Poco satisfecho">Poco satisfecho</label>
                                    <label class="radio-inline"><input type="radio" name="p4" value="Mala">Mala</label>
                                    <label class="radio-inline"><input type="radio" name="p4" value="Nada satisfecho">Nada satisfecho</label>
                                </td>
                            </tr> 
                            ...
                            <tr>
                                <td>
                                    <label class="radio-inline"><input type="radio" name="p5" value="5">5</label>
                                    <label class="radio-inline"><input type="radio" name="p5" value="6">6</label>                        
                                    <label class="radio-inline"><input type="radio" name="p5" value="7">7</label>
                                    <label class="radio-inline"><input type="radio" name="p5" value="8">8</label>
                                    <label class="radio-inline"><input type="radio" name="p5" value="9">9</label>
                                ...
                                <td>
                                    <table class="table-bordered col-md-offset-1 col-md-9 col-lg-9 col-xs-12 col-sm-12 p6estilo">
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center"><input type="radio" name="p6op2" value="Muy bueno"></td>
                                            <td class="text-center"><input type="radio" name="p6op2" value="Bueno"></td>
                                            <td class="text-center"><input type="radio" name="p6op2" value="Malo"></td>
                                            <td class="text-center"><input type="radio" name="p6op2" value="Muy malo"></td>                                                                
                                        </tr>
                                        <tr>
                                            <td>Facilidad de navegación</td>
                                            <td class="text-center"><input type="radio" name="p6op3" value="Muy bueno"></td>
                                            <td class="text-center"><input type="radio" name="p6op3" value="Bueno"></td>
                                            <td class="text-center"><input type="radio" name="p6op3" value="Malo"></td>
                                            <td class="text-center"><input type="radio" name="p6op3" value="Muy malo"></td>                                                                
                                        </tr>   
                                        <tr>
                                            <td>Rapidez de descarga</td>
                                            <td class="text-center"><input type="radio" name="p6op4" value="Muy bueno"></td>
                                            <td class="text-center"><input type="radio" name="p6op4" value="Bueno"></td>
                                            <td class="text-center"><input type="radio" name="p6op4" value="Malo"></td>
                                            <td class="text-center"><input type="radio" name="p6op4" value="Muy malo"></td>                                                                
                                        </tr>                              
                                    </table>
                                </td></tr>
                            ...
                            <tr>
                                <td>
                                    <label class="radio-inline"><input type="radio" name="p7" value="Muy probable">Muy probable</label>
                                    <label class="radio-inline"><input type="radio" name="p7" value="Probable">Probable</label>                        
                                    <label class="radio-inline"><input type="radio" name="p7" value="Poco probable">Poco probable</label>
                            ...
                            <tr>
                                <td>
                                    ...
                                    <label class="radio-inline"><input type="radio" name="p8" value="No">No los recomendaría</label>                        
                                </td>
                            </tr>                         
                            ...
                            <tr>
                                <td>
                                    <label class="radio-inline"><input type="radio" name="p9" value="Español">Español</label>
                                    <label class="radio-inline"><input type="radio" name="p9" value="Matemáticas">Matemáticas</label>                        
